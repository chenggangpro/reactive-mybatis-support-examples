...
public class MybatisR2dbcBaseTests extends R2dbcTestConfig {
    ...
    public R2dbcMybatisProperties r2dbcMybatisProperties(){
        ...
        r2dbcMybatisProperties.setTypeAliasesPackage("pro.chenggang.example.reactive.mybatis.r2dbc.entity.model");
    ...
    public R2dbcConnectionFactoryProperties r2dbcConnectionFactoryProperties(){
        ...
        r2dbcConnectionFactoryProperties.setR2dbcUrl("r2dbc:postgresql://"+super.databaseIp+":"+super.databasePort+"/"+super.databaseName);
